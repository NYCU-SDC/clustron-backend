...
-- name: Create :one
INSERT INTO group_role (role, access_level) VALUES ($1, $2) RETURNING *;

-- name: CreateWithID :one
INSERT INTO group_role (id, role, access_level) VALUES ($1, $2, $3) RETURNING *;

-- name: Update :one
UPDATE group_role SET role = $1, access_level = $2 WHERE id = $3 RETURNING *;
