...
const addPendingGroupMember = `-- name: AddPendingGroupMember :one
...
type AddPendingGroupMemberParams struct {
	UserIdentifier string
	GroupID        uuid.UUID
	RoleID         uuid.UUID
}

func (q *Queries) AddPendingGroupMember(ctx context.Context, arg AddPendingGroupMemberParams) (PendingGroupMember, error) {
	row := q.db.QueryRow(ctx, addPendingGroupMember, arg.UserIdentifier, arg.GroupID, arg.RoleID)
