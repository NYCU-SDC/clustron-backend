...
type Store interface {
	...
	ListWithPaged(ctx context.Context, userID uuid.UUID, groupID uuid.UUID, globalRole string, page int, size int, sort string, sortBy string) ([]MemberResponse, error)
